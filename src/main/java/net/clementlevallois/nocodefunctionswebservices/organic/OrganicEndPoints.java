...
import net.clementlevallois.umigon.classifier.organic.ClassifierOrganicOneWordInADocument;
...
public class OrganicEndPoints {
    ...
    public static Javalin addAll(Javalin app, UmigonController umigonController) throws Exception {
        ...
        ClassifierOrganicOneWordInADocument classifierOneWordFR = new ClassifierOrganicOneWordInADocument(umigonController.getSemanticsFR());
        ClassifierOrganicOneWordInADocument classifierOneWordEN = new ClassifierOrganicOneWordInADocument(umigonController.getSemanticsEN());

        app.post("/api/organicForOneTermInAText/{lang}", ctx -> {
            ...
            if (body.isEmpty()) {
                ...
                ClassifierOrganicOneWordInADocument classifier = null;
        ...
        app.get("/api/organicForOneTermInAText/{lang}", ctx -> {
            NaiveRateLimit.requestPerTimeUnit(ctx, 50, TimeUnit.SECONDS);
            JsonObjectBuilder objectBuilder = Json.createObjectBuilder();
